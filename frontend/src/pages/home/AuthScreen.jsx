      ...
      {/* Navbar */}
        ...
        <div>
            ...
            <div className="py-10 bg-black text-white">
                ...
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col ox-4 md:px-2">
                    {/* left side */}
                    <div className="flex-1 text-center md:text-left">
            ...
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
                    ...
                    {/* right side */}
                    <div className="flex-1 text-center md:text-left">
                        <h2 className="text-4xl md:tex-5xl font-extrabold mb-4">Create profiles for kids</h2>
                        <p className="text-lg md:text-xl">
